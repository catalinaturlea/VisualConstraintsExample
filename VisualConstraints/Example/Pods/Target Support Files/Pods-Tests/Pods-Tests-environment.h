...
// VisualConstraints
#define COCOAPODS_POD_AVAILABLE_VisualConstraints
#define COCOAPODS_VERSION_MAJOR_VisualConstraints 1
#define COCOAPODS_VERSION_MINOR_VisualConstraints 0
#define COCOAPODS_VERSION_PATCH_VisualConstraints 0
